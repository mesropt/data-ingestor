...
- [ ] 02-01-PLAN.md — Field-set model + safe YAML/JSON loader + runtime `create_model` schema + emptied domain sites + `--fields` CLI + exit code 5 (FIELD-01, FIELD-02, FIELD-03, FIELD-04, MAP-01, MAP-02)
