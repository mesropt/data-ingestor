...
- [ ] 04-01-PLAN.md — Service seam: extract public service.py (behavior-preserving CLI refactor), typed exceptions, loader.from_dict, add fastapi/uvicorn/multipart (API-01/02/03)
- [ ] 04-02-PLAN.md — FastAPI app + /api/upload + auto-apply spy + app.frontend() serving (API-01, API-03)
- [ ] 04-03-PLAN.md — Server-side confirm gate + FieldSetTemplateStore + field-sets/structural-hint/export endpoints + money-shot API test (API-02, UI-01, UI-02)
...
| 4. API & Review UI | 0/6 | Not started | - |
